...
## Architecture And Security Skills

Architecture/security skills may help inspect DDD boundaries, package topology, secrets, and redaction. They never override project conventions and never replace reviewer, security-reviewer, QA, or AIDD gates.
